<template>
    <header
        ...
        <router-link to="/" class="flex items-center">
            <img :src="logo" alt="Logo" class="h-16 w-auto" /> <!-- Agrandi le logo -->
        </router-link>

        <!-- Navigation -->
        <div class="flex items-center space-x-8 text-sm font-medium"> <!-- Augmenté l'espacement -->
...
.wave-effect {
    ...
    z-index: -1;
    /* Assurez-vous que l'effet de vague est derrière le contenu */
}
</style>
