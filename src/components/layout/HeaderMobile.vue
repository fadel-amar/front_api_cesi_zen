<template>
  <footer
    class="fixed bottom-4 left-4 right-4 bg-white/70 backdrop-blur-md rounded-2xl shadow-md border border-gray-200 text-gray-900 flex justify-around items-center px-4 py-3 z-50">
